"""
Train GAT and GraphSAGE models on Yelp dataset with memory optimization.
This script is designed to train models that failed due to OOM errors.

Memory optimization strategies:
1. Reduced hidden dimensions (32 instead of 64)
2. Fewer attention heads for GAT (2 instead of 8)
3. Aggressive dropout
4. Explicit memory clearing between operations
...
print("=" * 70)
print("YELP DATASET - GAT & GraphSAGE TRAINING")
print("=" * 70)
...
class GAT(torch.nn.Module):
    """Memory-optimized GAT with fewer heads and smaller hidden dim"""
...
def main():
    ...
    # Save results
    results_file = 'models/Yelp_GAT_SAGE_training_results.json'
    ...
    if len(failed_models) > 0:
        ...
        print("  2. Reduce number of GAT attention heads to 1")
